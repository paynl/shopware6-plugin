...
import PaynlPayPartsCardPlugin from './paynl-payment-plugin/paynl-payparts-card.plugin';
...
PluginManager.register('PaynlPaypartsCard', PaynlPayPartsCardPlugin, '[data-paynl-payparts-card]');
